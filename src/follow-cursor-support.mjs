...
function detect() {
  ...
  if (isWayland) {
    return {
      supported: false,
      reason: 'Wayland follow-cursor is disabled without a compositor-specific backend',
    };
  }
  ...
  if (isX11) {
    return {
      supported: false,
      reason: 'X11 follow-cursor backend is not implemented yet',
    };
  }

  return {
    supported: false,
    reason: 'No supported follow-cursor backend detected',
  };
}
